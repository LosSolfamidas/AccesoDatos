...
public final class ViviendasGestionar extends javax.swing.JDialog implements TableModelListener {
    ...
    public void cargarTablaViviendas() {
        ...
        if (!buscar) {
            listaViviendas = Metodos.viviendasSELECT();
        }
    ...
    public void cargarTablaHabitantes() {
        ...
        listaHabitantes = Metodos.habitantesSELECT(viviendaSeleccionada);
    ...
    private void btnEliminarViviendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarViviendaActionPerformed
        ...
        if (index != -1) {
            ...
            if (respuesta == JOptionPane.YES_OPTION) {
                if (Metodos.viviendaDELETE(viviendaSeleccionada)) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (TablaPrincipal.getSelectedRow() != -1) {
            if (validarDatosUpdate() == true) {
                ...
                String Calle = txtCalleUpdate.getText();
                String Numero = txtNumeroUpdate.getText();
                String Tipo = txtTipoUpdate.getText();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String Calle = txtBuscarVivienda.getText();
        ...
        if (Calle.isEmpty() || Calle.equalsIgnoreCase("")) {
            ...
            listaViviendas = Metodos.viviendaBUSQUEDA(Calle);
            buscar = true;
            cargarTablaViviendas();
            listaViviendas = Metodos.viviendasSELECT();
        }
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        ...
        if (validarDatosInsert() == true) {
            String Calle = txtCalleInsert.getText();
            String Numero = txtNumeroInsert.getText();
            String Tipo = txtTipoInsert.getText();
    ...
    private void btnEliminarHabitanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarHabitanteActionPerformed
        ...
        if (index != -1) {
            ...
            if (respuesta == JOptionPane.YES_OPTION) {
                ...
                if (Metodos.registrarPersonaUPDATE(habitanteSeleccionado, registrar)) {

                    if (Metodos.personaEnViviendaDELETE(habitanteSeleccionado, viviendaSeleccionada)) {
    ...
    public void BaseDatosINSERT(String Calle, String Numero, String Tipo, ArrayList<Persona> habitantes) {
        ...
        int IDVivienda = Controlador.Metodos.nuevaIDVivienda();

        //Creamos el Objeto
        Vivienda viviendaINSERT = new Vivienda(IDVivienda, Calle, Numero, Tipo, habitantes);

        if (Controlador.Metodos.viviendaINSERT(viviendaINSERT)) {
    ...
    public void BaseDatosUpdate(String calle, String numero, String Tipo) {
        ...
        if (Controlador.Metodos.viviendaUPDATE(viviendaUpdate)) {
