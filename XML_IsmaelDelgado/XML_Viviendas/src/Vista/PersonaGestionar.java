...
import Controlador.MetodosPersonas;
...
public final class PersonaGestionar extends javax.swing.JDialog implements TableModelListener {
    ...
    public void cargarTabla() {
        ...
        if (!buscar) {
            listaTotalPersonas = MetodosPersonas.personasSELECT();
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (index != -1) {
            ...
            if (respuesta == JOptionPane.YES_OPTION) {
                ...
                if (MetodosPersonas.personaDELETE(persona)) {
                    cargarTabla();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (Nombre.isEmpty() || Nombre.equalsIgnoreCase("")) {
            ...
            listaTotalPersonas = MetodosPersonas.personaBUSCAR(Nombre);
            buscar = true;
            cargarTabla();
            listaTotalPersonas = MetodosPersonas.personasSELECT();
        }
    ...
    private void btnActualizarPersonaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarPersonaActionPerformed
        if (tablaPersonas.getSelectedRow() != -1) {
            if (validarDatosUpdate() == true) {
                ...
                String Apellidos = txtApellidosUpdate.getText().toUpperCase();
                int nacimiento = Integer.parseInt(spnNacimientoUpdate.getValue().toString());
                String Telefono = txtTelefonoUpdate.getText().toUpperCase();
                ...
                if (respuesta == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        Logger.getLogger(PersonaGestionar.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        } else {
    ...
    public void BaseDatosINSERT(String nombre, String apellidos, int nacimiento, String telefono, boolean registrada) {
        ...
        int IDPersona = MetodosPersonas.nuevaID_Persona();

        //Creamos el Objeto
        Persona personaINSERT = new Persona(IDPersona, nombre, apellidos, nacimiento, telefono, registrada);

        if (MetodosPersonas.personaINSERT(personaINSERT)) {
    ...
    public void BaseDatosUpdate(String nombre, String apellidos, int nacimiento, String telefono, boolean registrada) throws XMLDBException {

        Persona personaUpdate = new Persona(personaSeleccionada.getID_Persona(), nombre, apellidos, nacimiento, telefono, registrada);

        if (Controlador.MetodosPersonas.personaUPDATE(personaUpdate)) {
            //Mensaje de confirmación
