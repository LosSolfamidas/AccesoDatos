...
import static Controlador.MetodosHabitantes.listadoPersonasNoReg;
import Objetos.Persona;
import static Vista.PersonaGestionar.actualizar;
...
public final class RegistrarPersonas extends javax.swing.JDialog implements TableModelListener {
    ...
    public void cargarTablaNoReg() {
        ...
        MetodosHabitantes.personasNoRegSELECT();
    ...
    private void btnAnyadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnyadirActionPerformed
        ...
        if (TablaNoRegistradas.getSelectedRow() != -1) {
            ...
            if (preguntaRegistrar == JOptionPane.YES_OPTION) {
                ...
                try {
                    if (Controlador.MetodosHabitantes.registrarPersonaUPDATE(personaSeleccionada, registrar)) {
                        if (Controlador.MetodosHabitantes.personaEnViviendaUPDATE(personaSeleccionada, viviendaSeleccionada)) {
                            cargarTablaNoReg();
                            JOptionPane.showMessageDialog(this, "Habitante inscrito en vivienda");
                        } else {
                            JOptionPane.showMessageDialog(this, "Error al añadir persona en vivienda", "ERROR", JOptionPane.ERROR_MESSAGE);
                        }
                    } else {
                        JOptionPane.showMessageDialog(this, "Error al registrar persona", "ERROR", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (XMLDBException ex) {
                    Logger.getLogger(RegistrarPersonas.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void TablaNoRegistradasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaNoRegistradasMouseClicked
        ...
        System.out.println("personaSeleccionada: " + personaSeleccionada.getNombre());
